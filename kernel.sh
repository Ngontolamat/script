...
#Now Its time for other stuffs like cloning, exporting, etc
 ...
 clone() {
	...
	git clone --depth 1 --no-single-branch https://github.com/Saiful-220/AnyKernel3.git -b master
}

##------------------------------------------------------##

exports() {
	export KBUILD_BUILD_USER="saiful220"
	export ARCH=arm64
...
tg_post_msg() {
	curl -s -X POST "$BOT_MSG_URL" -d chat_id="-1001154912826" \
